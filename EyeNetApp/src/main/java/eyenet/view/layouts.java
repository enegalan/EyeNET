...
public class layouts extends JFrame implements ActionListener {
    ...
    private JLabel layoutsTitleText,libraryImage,libraryText,barbershopImage,barbershopText,manufacturingImage,manufacturingText;
    private JPanel leftPanelContent,right4Panelcontent, right4Panel, right3Panelcontent, right3Panel, right2Panel, right2Panelcontent, right1Panelcontent,rightContent,rightPanel,main, leftPanel,header,leftHeader,leftHeaderContent,rightHeader,rightHeaderContent,link1Panel,link1PanelContent,link2Panel,link2PanelContent,link3Panel,link3PanelContent,link4Panel,link4PanelContent,link5Panel,link5PanelContent,link6Panel,link6PanelContent, right1Panel, link7Panel,link7PanelContent;
    private JPanel centerPanel,centerPanelContent,tablesPanel,libraryPanel,libraryIconPanel,libraryContentPanel,barbershopPanel,barbershopIconPanel,barbershopContentPanel,manufacturingPanel,manufacturingIconPanel,manufacturingContentPanel;
    private ImageIcon settingIcon,languageIcon,darkModeIcon,logOutImageIcon,barsIcon,userIcon,dashboardIcon,layoutsIcon,modulesIcon, statisticsIcon,databasesIcon, assignmentsIcon,toolsIcon,libraryIcon,barbershopIcon,manufacturingIcon;
    /*COLORS RGB*/
    ...
    public layouts() throws IOException, FontFormatException {
        ...
        centerPanelContent.setBackground(first_color);
        centerPanelContent.setBorder(new EmptyBorder(40,40,0,20));
        ...
        layoutsTitleText = new JLabel("Layouts");
        centerPanelContent.add(layoutsTitleText);


        //LIBRARY LAYOUT
        libraryPanel = new JPanel(new BorderLayout());

        libraryIconPanel = new JPanel();
        libraryIconPanel.setBackground(new Color(161, 161, 161));
        libraryIconPanel.setBorder(new EmptyBorder(20,0,20,0));
        libraryIcon = new ImageIcon("src/main/java/eyenet/view/images/layouts/library.png");
        libraryImage = new JLabel(libraryIcon);

        libraryIconPanel.add(libraryImage);

        libraryContentPanel = new JPanel();
        libraryContentPanel.setBorder(new EmptyBorder(20,50,20,50));
        libraryText = new JLabel("Library");
        libraryContentPanel.add(libraryText);

        libraryPanel.add(libraryIconPanel,BorderLayout.NORTH);
        libraryPanel.add(libraryContentPanel,BorderLayout.SOUTH);

        //BARBERSHOP LAYOUT
        barbershopPanel = new JPanel(new BorderLayout());

        barbershopIconPanel = new JPanel();
        barbershopIconPanel.setBackground(new Color(161, 161, 161));
        barbershopIconPanel.setBorder(new EmptyBorder(20,0,20,0));
        barbershopIcon = new ImageIcon("src/main/java/eyenet/view/images/layouts/barbershop.png");
        barbershopImage = new JLabel(barbershopIcon);

        barbershopIconPanel.add(barbershopImage);

        barbershopContentPanel = new JPanel();
        barbershopContentPanel.setBorder(new EmptyBorder(20,50,20,50));
        barbershopText = new JLabel("Barbershop");
        barbershopContentPanel.add(barbershopText);

        barbershopPanel.add(barbershopIconPanel,BorderLayout.NORTH);
        barbershopPanel.add(barbershopContentPanel,BorderLayout.SOUTH);

        //MANUFACTURING LAYOUT
        manufacturingPanel = new JPanel(new BorderLayout());

        manufacturingIconPanel = new JPanel();
        manufacturingIconPanel.setBackground(new Color(161, 161, 161));
        manufacturingIconPanel.setBorder(new EmptyBorder(20,0,20,0));
        manufacturingIcon = new ImageIcon("src/main/java/eyenet/view/images/layouts/manufacturing.png");
        manufacturingImage = new JLabel(manufacturingIcon);

        manufacturingIconPanel.add(manufacturingImage);

        manufacturingContentPanel = new JPanel();
        manufacturingContentPanel.setBorder(new EmptyBorder(20,50,20,50));
        manufacturingText = new JLabel("Manufacturing");
        manufacturingContentPanel.add(manufacturingText);

        manufacturingPanel.add(manufacturingIconPanel,BorderLayout.NORTH);
        manufacturingPanel.add(manufacturingContentPanel,BorderLayout.SOUTH);



        tablesPanel.add(libraryPanel);
        tablesPanel.add(barbershopPanel);
        tablesPanel.add(manufacturingPanel);
        ...
        Font h1_font = Font.createFont(Font.PLAIN, fontFile);
        h1_font = h1_font.deriveFont(Font.PLAIN,16);
        ...
        layoutsTitleText.setFont(h1_font);
        libraryText.setFont(main_font);
        barbershopText.setFont(main_font);
        manufacturingText.setFont(main_font);
        ...
        MouseListener mouseListener = new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) {
                ...
                if(e.getSource().equals(libraryPanel)){
                    libraryIconPanel.setBackground(new Color(161, 161, 161));
                }
                if(e.getSource().equals(barbershopPanel)){
                    barbershopIconPanel.setBackground(new Color(161, 161, 161));
                }
                if(e.getSource().equals(manufacturingPanel)){
                    manufacturingIconPanel.setBackground(new Color(161, 161, 161));
                }
            }
            @Override
            public void mouseEntered(MouseEvent e){
                ...
                if(e.getSource().equals(libraryPanel)){
                    libraryPanel.setCursor(cursor);
                    libraryIconPanel.setBackground(new Color(121, 121, 121));
                }
                if(e.getSource().equals(barbershopPanel)){
                    barbershopPanel.setCursor(cursor);
                    barbershopIconPanel.setBackground(new Color(121, 121, 121));
                }
                if(e.getSource().equals(manufacturingPanel)){
                    manufacturingPanel.setCursor(cursor);
                    manufacturingIconPanel.setBackground(new Color(121, 121, 121));
                }
        ...
        libraryPanel.addMouseListener(mouseListener);
        barbershopPanel.addMouseListener(mouseListener);
        manufacturingPanel.addMouseListener(mouseListener);
