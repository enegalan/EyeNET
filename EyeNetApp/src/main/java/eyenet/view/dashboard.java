...
public class dashboard extends JFrame implements ActionListener {
    ...
    private JPanel leftPanelContent,right4Panelcontent, right4Panel, right3Panelcontent, right3Panel, right2Panel, right2Panelcontent, right1Panelcontent,rightContent,rightPanel,main, leftPanel,header,leftHeader,leftHeaderContent,rightHeader,rightHeaderContent,link1Panel,link1PanelContent,link2Panel,link2PanelContent,link3Panel,link3PanelContent,link4Panel,link4PanelContent,link5Panel,link5PanelContent,link6Panel, link6PanelContent, link7Panel, link7PanelContent, right1Panel, centerPanel, centerPanelContent, statisticsPanel;
    private JPanel statistic1Panel;
    ...
    public dashboard() throws IOException, FontFormatException {
        ...
        statisticsPanel.setBackground(first_color);
        statisticsPanel.setBorder(new EmptyBorder(50,50,50,50));

        statistic1Panel = new JPanel();
        statistic1Panel.setBackground(first_color);
        statistic1Panel.setLayout(new GridLayout(2,1,0,0));
        ImageIcon usersRegisteredIcon = new ImageIcon("src/main/java/eyenet/view/images/frames/usersRegisteredMonth.png");
        JLabel usersRegisteredImage = new JLabel(usersRegisteredIcon);
        JLabel usersRegisteredText = new JLabel("Users Registered this month: March");
        statistic1Panel.add(usersRegisteredText);
        statistic1Panel.add(usersRegisteredImage);

        JPanel statistic2Panel = new JPanel();
        statistic2Panel.setBackground(first_color);
        ImageIcon usersRegisteredDataIcon = new ImageIcon("src/main/java/eyenet/view/images/frames/usersRegisteredMonthData.png");
        JLabel usersRegisteredDataImage = new JLabel(usersRegisteredDataIcon);
        statistic2Panel.add(usersRegisteredDataImage);


        statisticsPanel.add(statistic1Panel);
        statisticsPanel.add(statistic2Panel);

        centerPanelContent.add(statisticsPanel);
        ...
        usersRegisteredText.setFont(h1_font);
        ...
        MouseListener mouseListener = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(link5Panel.equals(e.getSource())){
                    databases databases = null;
                    try {
                        databases = new databases();
                    } catch (IOException ex) {
